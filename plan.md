...
- [ ] Establish and live-verify the authenticated native-mTLS Tempo ingest gateway with exact Alloy identity, tenant enforcement, route allowlisting, and filesystem certificate reload.
